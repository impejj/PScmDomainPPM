...
class Severity {
	...
	/*
	 * Se refiere a cuan grave es el issue/Tarea que se esta informando...
	 * 
	 * 
	 * 
	 */
	...
	String        description
    String			   detail
	Integer             level    //Campo que nos permite establecer un punto de comparacion 
	...
	static constraints = {
	        ...
	        description(nullable: false , display:true )
				 ...
				 level(nullable: true , display:false )
